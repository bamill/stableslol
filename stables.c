...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/10 22:29:55 by bmiller           #+#    #+#             */
/*   Updated: 2017/03/10 22:38:44 by bmiller          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			allocate_loads_of_memory(void)
{
	...
	safe_free((void**)&int_pointer_powa);
	safe_free((void**)&pointer_powa);
	safe_free((void**)&another_pointer);
}
